...
# 4. 統合稿
# ============================================================
add_heading("4. 教育長前文（150周年案）— 統合稿（小学校版・約550文字）", level=1)
...
body_paragraphs = [
    "〇〇小学校が、創立150周年の佳節を迎えられましたことを、"
    "練馬区教育委員会を代表して心よりお祝い申し上げます。",

    "明治の創立以来、本校は地域の児童とともに四つの時代を歩んでまいりました。"
    "120周年の年、情報化と国際化の入口に立ち、130周年には教育基本法が改正され、"
    "学校・家庭・地域が手を携える教育の在り方が問い直されました。"
    "140周年の年、新しい学習指導要領のもと、主体的・対話的で深い学びの実現に"
    "挑んでおりました。",

    "140周年から今日に至る十年は、本校の歴史でも最も急峻な十年でした。"
    "世界的な感染症は児童から当たり前の登校や行事を一時奪い、"
    "GIGAスクール構想は学びの姿を大きく変えました。"
    "校則の在り方が地域全体で議論され、子どもの権利と安全、ウェルビーイングを"
    "学校運営の中心に据える方針を、練馬区として確かなものとしてまいりました。"
    "学校で起きた出来事を真摯に検証してきた時間もまた、150年の重みの一部です。",

    "いま、学校は、行政・教職員・保護者・地域・議会、そして児童自身が"
    "ともに営む公共空間です。150年は通過点です。"
    "児童一人ひとりが「ここにいてよかった」と思える学校を、"
    "練馬区教育委員会は全力で支えてまいります。",

    "結びに、本校の益々の発展と関係者の皆様の御健勝を祈念し、"
    "お祝いの言葉といたします。",
]
