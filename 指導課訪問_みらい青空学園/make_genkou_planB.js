...
body.push(
  infoTable([
    ...
    ["時　間", "冒頭の挨拶等 １〜２分　＋　本原稿 約８分（合計 ９〜10分）"],
  ])
);
...
body.push(
  ...
  small("・冒頭の挨拶・自己紹介・御礼は、資料に入る前に１〜２分で行う。本原稿はそのあとの分。")
  ,small("・全文で約２，３８０字。ふつうの速さで読んで、クイズの間を含め約８分です。"),
...
body.push(cue("挨拶・自己紹介・御礼は、資料に入る前に１〜２分で行う"));
body.push(say("それでは、始めます。"));
body.push(say("本日申し上げたいことは、この一文に尽きます。「違い」を生かす授業が、９年間の学びをつなぐ。"));

body.push(head("スライド２", "0:11", "本日の講評"));
body.push(say("お話は三点です。"));
body.push(say("クイズと本校の現状、３人の先生の授業から、そして今後に向けて。"));
body.push(say("指導案を手がかりに、本日の授業を読み解いてまいります。"));

/* ===== ① アイスブレイク・現状 ===== */
body.push(head("スライド３", "0:24", "①　アイスブレイク　クイズ"));
body.push(say("全国学力・学習状況調査の質問紙調査から、二問です。"));
body.push(say("「英語の勉強は好きですか」は、全国では小学校から中学校で１５．５ポイント下がります。では、本校はどうだったでしょうか。"));
...
body.push(head("スライド４", "1:24", "①　アイスブレイク　答え"));
body.push(say("答えは、いずれも③です。"));
body.push(say("英語は、５１．８から６１．７パーセントへ。全国が１５．５ポイント下がる項目で、本校は９．９ポイント上がっています。"));
body.push(say("小学部では全国を下回っていたものが、中学部では全国を１０ポイント以上、上回りました。"));
body.push(say("「自分には、よいところがある」も、６．３ポイント上がっています。"));
body.push(say("全国も東京都も下がる項目で、本校は上がっている。これが、本日の出発点です。"));

body.push(head("スライド５", "2:00", "①　みらい青空学園の現状"));
body.push(say("対話と協働に関わる項目も、同じように伸びています。"));
body.push(say("「協力しながら課題の解決に取り組んでいますか」は、８５．１から１００パーセントへ。中学部は、全員が肯定的に答えています。"));
body.push(say("三つとも、中学部は練馬区や全国を上回っています。対話し、協働する力が、確かに育っています。"));

/* ===== ② ３人の授業から ===== */
body.push(head("スライド６", "2:26", "②　３つの指導案に共通して書かれていたこと"));
body.push(say("では、なぜ育っているのか。３人の先生の指導案を読ませていただきました。"));
body.push(say("水泳は泳力差が顕著、外国語は習熟度差が大きい、道徳は特別支援学級。３つの学級は、いずれも一人一人の差が大きい集団です。"));
body.push(say("その差にどう向き合うか。指導案には、共通する手だてが書かれていました。"));
body.push(say("見通しをもたせる。違いに応じる。対話で考えを深める。この３つを手がかりに、３人の授業を見てまいります。"));

body.push(head("スライド７", "3:02", "②　田口　和磨　先生"));
body.push(say("田口先生。保健体育、第９学年ＡＢ組。水泳の第３時、バタフライのキックでした。"));
body.push(say("指導案には、コロナ禍と校舎改築で授業回数が少なく、苦手意識をもつ生徒とスイミングスクール経験者が混在し、泳力差が顕著、とあります。"));
body.push(say("そのうえで、着替えの前に目標と流れを確認する。泳力別に３段階のコース。得意な生徒にアドバイス役を担わせる。バディで互いのキックを確認し合う。"));
body.push(say("参観して印象的だったのは、確認の視点を三点、明確に示されていたことです。子どもが自分の泳ぎを見る目をもてていました。"));

body.push(head("スライド８", "3:48", "②　東海林　静江　先生"));
body.push(say("東海林先生。道徳、特別支援学級Ｄ組。「ついていい嘘とついてはいけない嘘はどう違うのか」でした。"));
body.push(say("指導案には、将来の就労を見据えた「報告・連絡・相談」を大切にしている学級であること、人狼ゲームをめぐる生徒の発言が出発点だとあります。"));
body.push(say("前時と２週続きで組み立てる。前時のワークシートを活用し、考えが変わってもよいと保障する。自己との対話で整理してから、議論へ。発表より議論の時間を重視する。"));
body.push(say("参観して、全員が自分の考えをもって議論に入れていました。"));

body.push(head("スライド９", "4:32", "②　塚本　瑞穂　先生"));
body.push(say("塚本先生。外国語、第７学年Ｂ組。Unit 4 の第２時でした。"));
body.push(say("指導案には、苦手意識のある生徒から母語が英語の生徒、英検２級レベルの生徒まで混在し、習熟度の差が大きい、とあります。"));
body.push(say("Today’s Goal と Plan を提示する。単元末はＡＬＴへの発表で、目的と相手が明確なゴールを置く。発表の前にペアで共有し、くじで指名して全員に発話の機会をつくる。"));
body.push(say("参観して、板書を手がかりに、誰もが一文をつくれるようにされていました。"));

body.push(head("スライド１０", "5:14", "②　３つの授業に共通していたこと"));
body.push(say("３つの授業を並べると、このようになります。"));
body.push(say("見通し、違いに応じる、対話。どの授業にも、三つとも手だてが打たれていました。"));
body.push(say("教科も学年も違いますが、３人とも、差を埋めるのではなく、差を前提に授業を設計されていました。"));

body.push(head("スライド１１", "5:35", "②　この手だては、子どもに何を育てるか"));
body.push(say("では、この手だては、子どもに何を育てるのでしょうか。二つあると考えます。"));
body.push(say("一つは自己肯定感。「できる子になる」ことではなく、「成長できる自分を信じること」です。"));
body.push(say("もう一つが、学習の自己調整。学習指導要領が示す「学びに向かう力」の中核をなす力です。"));

body.push(head("スライド１２", "5:59", "②　学習の自己調整が育っていた場面"));
body.push(say("「主体的に学習に取り組む態度」は、粘り強く取り組む側面と、自らの学習を調整しようとする側面の二つで捉えます。"));
body.push(say("たとえば田口先生は、着替えの前に目標と流れを確認され、学習カードで要点を振り返らせていました。"));
body.push(say("３人とも、目標の確認と振り返りが一対で置かれています。"));
body.push(say("教師が管理する学習から、子どもが管理する学習へ。"));
body.push(cue("ひと呼吸おく"));
body.push(say("本日の授業から見えた、いちばん大きな変化です。"));

/* ===== ③ 今後に向けて ===== */
body.push(head("スライド１３", "6:37", "③　この３つを、９年間の共通の言葉に"));
body.push(say("今後に向けてです。本日見えた３つの視点は、学年や教科を越えて使えます。"));
body.push(say("学校経営計画の「主体的・対話的で深い学びの実現に向けた授業改善」「個に応じたきめ細やかな指導・支援の充実」とも重なります。"));
body.push(say("学年ごと、教科ごとに閉じない。同じ言葉で語れることが、９年間をつなぎます。"));

body.push(head("スライド１４", "7:04", "③　その言葉で、互いの授業を見合う"));
body.push(say("そして、もう一点。本日の３つの授業は、教科も学年も違います。それでも、同じ３つの視点で語ることができました。"));
...
body.push(head("スライド１５", "7:40", "まとめ"));
body.push(say("まとめます。３人とも、一人一人の差を学びの出発点にされていました。"));
