...
body.push(
  ...
  small("・全文で約３，０００字。ふつうの速さで読んでちょうど１０分です。"),
...
body.push(say("塚本先生、田口先生、東海林先生、そして本日ご準備いただいた先生方に、まず御礼を申し上げます。"));
...
body.push(say("令和８年度の全国学力・学習状況調査、練馬区の質問紙調査からの出題です。"));
body.push(say("第一問。「将来の夢や目標を持っていますか」。"));
body.push(say("肯定的に答えた小学校６年生は、練馬区で８０．３パーセントです。"));
body.push(say("では、中学校３年生は何パーセントでしょうか。"));
body.push(say("①　約８０パーセント。②　約７３パーセント。③　約６６パーセント。"));
body.push(say("続いて第二問。「英語の勉強は好きですか」。"));
body.push(say("小学校６年生は６８．２パーセント。中学校３年生はどうでしょうか。"));
body.push(say("①　約６８。②　約６１。③　約５５。"));
body.push(cue("数秒待つ。挙手を求めるか、近くの先生同士で一言交わしていただく"));

body.push(head("スライド４", "1:20", "０　アイスブレイク　答え"));
body.push(say("答えは、いずれも③です。"));
body.push(say("「将来の夢や目標」は、６５．５パーセント。１４．８ポイント下がります。"));
body.push(say("「英語の勉強が好き」は、５４．７パーセント。１３．５ポイント下がります。"));
body.push(say("同じ子どもが、３年の間にこれだけ変わる。"));
body.push(say("これが、いわゆる「中１ギャップ」と呼ばれる段差です。"));

body.push(head("スライド５", "1:45", "０　アイスブレイク　この段差は必然ではない"));
body.push(say("しかし、この段差は必然ではありません。"));
body.push(say("「学校に行くのは楽しい」は、小学校８８．９、中学校８７．２パーセント。"));
body.push(say("「自分と違う意見について考えるのは楽しい」は、小学校８０．６、中学校７９．８パーセント。"));
body.push(say("いずれも落差はわずかで、小・中ともに東京都と全国を上回っています。"));
body.push(say("つまり、つなぎ方次第で、段差はなだらかにできる。"));
body.push(say("その仕組みが、９年間を見通した教育、すなわち小中一貫教育です。"));

/* ===== １ 練馬区の小中一貫教育 ===== */
body.push(head("スライド６", "2:10", "１　練馬区の小中一貫教育"));
...
body.push(say("期待される効果は三つ。授業改善による学力・体力の向上。連携指導による豊かな人間性・社会性の育成。そして、滑らかな接続による安定した学校生活の実現です。"));

body.push(head("スライド７", "2:35", "１　施設一体型の強み"));
body.push(say("施設一体型では、この効果がさらに高まります。教員間の連携強化、異学年交流の活性化、そして小中学校間の指導の統一化です。"));
body.push(say("本校は、区内２校目の施設一体型として、本年４月に開校した、開校１年目の学校です。"));
body.push(say("１年生から９年生までが同じ学び舎で学ぶ強みを生かし、「目指す１５歳の姿」を９年間で描いていくことに期待しています。"));

/* ===== 学力調査から見える強み ===== */
body.push(head("スライド８", "3:00", "学力調査結果から見える強み"));
body.push(say("ここから、本校のお話です。"));
body.push(say("まず授業そのものではなく、学力調査結果から見える子どもの姿について考えたいと思います。"));
body.push(say("本校では、学習規律、学習習慣、そして学びへの主体性が、着実に育っています。"));

body.push(head("スライド９", "3:25", "本校と練馬区の比較"));
body.push(say("数値で見てまいります。"));
body.push(say("本日お話しする三つの視点に対応する質問項目を並べました。"));
body.push(say("自己肯定感にあたる、「自分には、よいところがあると思いますか」。"));
body.push(say("対話・協働にあたる、「話し合う活動を通じて、自分の考えを深めたり、新たな考え方に気付いたりすることができていますか」。"));
body.push(say("学習の自己調整にあたる、「分かった点や分からなかった点を見直し、次の学習につなげることができていますか」。"));
body.push(say("いずれの項目でも、本校は練馬区平均を上回っています。"));
body.push(say("調査は一時点の結果ですが、その背景には、先生方の日々の授業の積み重ねがあると受け止めております。"));
body.push(cue("本校の数値が確定したら、この段落を実際の値に読み替える。一部が区平均を下回った場合は「〇項目で上回っています」と述べ、上回った項目を具体に挙げる"));

body.push(head("スライド１０", "4:05", "なぜその成果が現れているのか"));
...
/* ===== ① 自己肯定感 ===== */
body.push(head("スライド１１", "4:25", "２-①　自己肯定感"));
...
body.push(head("スライド１２", "4:50", "２-①　自己肯定感を育む授業"));
body.push(say("田口先生の授業では、泳力差の大きい集団に対して、段階的な課題設定、泳力別のコース編成、バディでの確認活動が用意されていました。"));
body.push(say("バタフライのキックについて、確認の視点を三点、明確に示されていました。"));
body.push(say("これにより、子どもが自分の泳ぎを見る目をもつことができていました。"));
body.push(say("東海林先生の授業では、安心して自分の考えを表現できる環境がつくられていました。"));
body.push(say("前時のワークシートの考えを大切にしながら、エピソードの提示によって、意見が変わってもよいと保障されていた点が印象的でした。"));
body.push(say("塚本先生の授業では、発表の前にペアで共有する時間が確保され、全員に発話の機会が用意されていました。"));
body.push(say("いずれも、子どもが「認められる」よりも、「自分で成長を実感する」経験を積み重ねる授業でした。"));

/* ===== ② 対話・協働 ===== */
body.push(head("スライド１３", "5:40", "２-②　対話・協働"));
body.push(say("二点目は、対話・協働です。"));
body.push(say("調査結果に表れた主体的な学びの土台は、一朝一夕にできるものではありません。"));
body.push(say("その背景には、日常的に積み重ねられている「対話を通した学び」があると受け止めました。"));

body.push(head("スライド１４", "6:00", "２-②　対話によって学びは深まる"));
body.push(say("保健体育では、バディで互いの泳ぎを見合い、改善点を考えていました。得意な生徒が助言役を担い、全員に役割がありました。"));
body.push(say("道徳では、「ついていい嘘と、ついてはいけない嘘」をテーマに、価値観の違いについて議論していました。発表よりも議論の時間を重視した構成でした。"));
body.push(say("外国語では、ペアでのやり取りを、全体の学びへつないでいました。音読も一人ではなく相手とともに行い、表現を確かなものにしていました。"));
body.push(say("教科は異なりますが、共通していたのは「相手を通して自分を見つめる学び」です。"));
body.push(say("これが、対話・協働の本質だと考えます。"));

/* ===== ③ 学習の自己調整 ===== */
body.push(head("スライド１５", "6:50", "２-③　学習の自己調整"));
...
body.push(head("スライド１６", "7:10", "２-③　自己調整が行われていた授業"));
...
/* ===== 今後・まとめ ===== */
body.push(head("スライド１７", "8:00", "今後に向けて"));
body.push(say("今後についてです。"));
...
body.push(say("学年や教科で完結させず、９年間の系統として整理していただきたいと考えます。"));
body.push(say("小竹小学校との校区別協議会も、その大切な場になります。"));

body.push(head("スライド１８", "9:05", "まとめ"));
body.push(say("まとめます。"));
...
body.push(
  ...
  small("出典：令和８年度　全国学力・学習状況調査（練馬区）　質問紙調査　肯定的回答の割合")
);

function dataTable(header, rows) {
  const widths = [4200, 1600, 1600, 1600];
...
body.push(
  new Paragraph({ spacing: { before: 200, after: 80 }, children: [new TextRun({ text: "アイスブレイク（スライド３〜５）", font: FONT_H, size: 20, bold: true })] })
);
body.push(
  dataTable(["質問項目", "小学校６年", "中学校３年", "差"], [
    ["将来の夢や目標を持っていますか", "80.3", "65.5", "−14.8"],
    ["英語の勉強は好きですか", "68.2", "54.7", "−13.5"],
    ["学校に行くのは楽しいと思いますか", "88.9", "87.2", "−1.7"],
    ["自分と違う意見について考えるのは楽しいと思いますか", "80.6", "79.8", "−0.8"],
  ])
);
body.push(small("※　下の２項目は、小・中とも東京都・全国を上回る。"));

body.push(
  new Paragraph({ spacing: { before: 240, after: 80 }, children: [new TextRun({ text: "本校と練馬区の比較（スライド９）", font: FONT_H, size: 20, bold: true })] })
);
body.push(
  dataTable(["質問項目（練馬区の値）", "小学校６年", "中学校３年", "本校"], [
    ["自分には、よいところがあると思いますか", "86.4", "83.3", "（記入）"],
    ["話し合う活動を通じて、考えを深められている", "87.0", "86.6", "（記入）"],
    ["分かった点・分からない点を見直し、次につなげている", "79.0", "79.0", "（記入）"],
  ])
);
body.push(small("※　本校の数値が確定したら、スライド９と本原稿の該当箇所を差し替える。"));
