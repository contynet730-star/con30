...
body.push(
  ...
  small("・全文で約２，９７０字。ふつうの速さで読んで、クイズの間を含め約１０分です。"),
...
/* ===== １ 練馬区の小中一貫教育 ===== */
body.push(head("スライド６", "3:16", "１　練馬区の小中一貫教育"));
...
body.push(say("ねらいは、学力・体力の向上、豊かな人間性の育成、そして滑らかな接続による安定した学校生活の実現です。"));

body.push(head("スライド７", "3:46", "１　施設一体型の強み"));
...
/* ===== 学力調査から見える強み ===== */
body.push(head("スライド８", "4:16", "学力調査結果から見える強み"));
body.push(say("学力調査結果から見える、子どもの姿です。"));
body.push(say("本校では、学習規律、学習習慣、そして学びへの主体性が、着実に育っています。"));

body.push(head("スライド９", "4:27", "本校と練馬区の比較"));
...
body.push(head("スライド１０", "5:11", "なぜその成果が現れているのか"));
...
/* ===== 本日の授業から（写真） ===== */
body.push(head("スライド１１", "5:32", "２　本日の授業から"));
body.push(say("ここからは、本日の授業を見てまいります。まず、３つの教室の様子です。"));
body.push(say("３つの教室に共通していたのは、子どもが動き、考え、伝える時間の多さでした。"));
body.push(cue("当日の写真を貼り付けて使用する。写真に触れながら一言添えると、ここで空気がやわらぐ"));

/* ===== ① 自己肯定感 ===== */
body.push(head("スライド１２", "5:46", "２-①　自己肯定感"));
...
body.push(head("スライド１３", "6:10", "２-①　自己肯定感を育む授業"));
body.push(say("田口先生は、泳力差の大きい集団に対して、段階的な課題設定、泳力別のコース、バディでの確認活動を用意されていました。"));
body.push(say("キックの確認の視点を三点示されたことで、子どもが自分の泳ぎを見る目をもつことができていました。"));
body.push(say("東海林先生は、安心して自分の考えを表現できる環境をつくられていました。意見が変わってもよいと保障されていた点が印象的でした。"));
body.push(say("塚本先生は、発表の前にペアで共有する時間を確保し、全員に発話の機会を用意されていました。"));
body.push(say("いずれも、子どもが「認められる」よりも、「自分で成長を実感する」経験を積み重ねる授業でした。"));

/* ===== ② 対話・協働 ===== */
body.push(head("スライド１４", "7:01", "２-②　対話・協働"));
body.push(say("二点目は、対話・協働です。"));
body.push(say("調査結果に表れた主体的な学びの土台。その背景には、日常的に積み重ねられている「対話を通した学び」があると受け止めました。"));

body.push(head("スライド１５", "7:15", "２-②　対話によって学びは深まる"));
body.push(say("保健体育では、バディで互いの泳ぎを見合い、改善点を考えていました。"));
body.push(say("道徳では、「ついていい嘘と、ついてはいけない嘘」をテーマに議論していました。発表よりも議論の時間を重視した構成でした。"));
body.push(say("外国語では、ペアでのやり取りを全体の学びへつないでいました。音読も相手とともに行っていました。"));
body.push(say("教科は異なりますが、共通していたのは「相手を通して自分を見つめる学び」です。これが対話・協働の本質だと考えます。"));

/* ===== ③ 学習の自己調整 ===== */
body.push(head("スライド１６", "7:54", "２-③　学習の自己調整"));
...
body.push(head("スライド１７", "8:12", "２-③　自己調整が行われていた授業"));
...
/* ===== 今後・まとめ ===== */
body.push(head("スライド１８", "8:58", "今後に向けて"));
...
body.push(head("スライド１９", "9:32", "まとめ"));
body.push(say("まとめます。"));
