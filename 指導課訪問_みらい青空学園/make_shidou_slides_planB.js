...
/* ---------- スライド１　表紙 ---------- */
{
  ...
  s.addNotes(
    "（挨拶・自己紹介・御礼は、資料に入る前に１〜２分で行う）\n" +
    "それでは、始めます。本日申し上げたいことは、この一文に尽きます。「違い」を生かす授業が、９年間の学びをつなぐ。"
  );
}
...
/* ---------- スライド１１　今後に向けて　９年間で系統化する ---------- */
{
  ...
  ["Ⅰ　見通し", "Ⅱ　違いに応じる", "Ⅲ　対話"].forEach((t, i) => {
    chip(s, MX + i * 3.0, 2.26, 2.7, 0.66, t, 15, true);
  });
  panel(s, MX, 3.18, BW, 1.32);
  s.addText(
    [
