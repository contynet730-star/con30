...
bullet("「原則第二土曜日」とする経緯・理由：平成24年度以降の基本。実施日をあらかじめ定めることで、"
       "保護者の参観予定や地域・区の行事計画の見通しが立ち、多くの方が参加・調整しやすい。"
       "→個別のご家庭に合わせて日を動かすと、この共通の見通しが損なわれる。")
...
qa = [
    ...
    ("Q6　なぜ「第二土曜日」なのか。その経緯は。",
     "A6　平成24年度以降、原則として第二土曜日を基本としてきた。実施日をあらかじめ定めることで、"
     "保護者の参観予定や地域・区の行事計画の見通しが立ち、多くの方が参加・調整しやすいため。"
     "令和８年度からは第二土曜日以外も可とし、柔軟化を図っている。"),
]
for q, a in qa:
