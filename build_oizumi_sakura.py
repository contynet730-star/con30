...
kokugo_data = [
    ["国語", "小R4", "小R5", "小R6", "小R7", "中R4", "中R5", "中R6", "中R7"],
    ["大泉桜学園", "60", "69", "62", "65", "72", "78", "60", "56"],
    ["練馬区", "69", "70", "71", "71", "72", "74", "62", "58"],
    ["東京都", "69", "69", "70", "70", "70", "72", "61", "57"],
    ["全国", "65.6", "67.2", "67.7", "66.8", "69", "69.8", "58.1", "54.3"],
]
add_table(slide4, Emu(180000), Emu(940000), Emu(4350000), Emu(820000),
          kokugo_data, body_size=7, header_size=7,
          col_widths=[Emu(850000), Emu(437000), Emu(437000), Emu(437000), Emu(437000), Emu(437000), Emu(437000), Emu(437000), Emu(441000)],
          highlight_cells=[(1, 1), (1, 3), (1, 4), (1, 7), (1, 8)],
          first_col_fill=COLOR_BG_BLUE)
...
sansu_data = [
    ["算数/数学", "小R4", "小R5", "小R6", "小R7", "中R4", "中R5", "中R6", "中R7"],
    ["大泉桜学園", "62", "69", "56", "52", "58", "62", "55", "52"],
    ["練馬区", "68", "69", "70", "65", "57", "57", "60", "55"],
    ["東京都", "67", "67", "68", "64", "54", "54", "57", "53"],
    ["全国", "63.2", "62.5", "63.4", "58", "51.4", "51", "52.5", "48.3"],
]
add_table(slide4, Emu(4610000), Emu(940000), Emu(4350000), Emu(820000),
          sansu_data, body_size=7, header_size=7,
          col_widths=[Emu(850000), Emu(437000), Emu(437000), Emu(437000), Emu(437000), Emu(437000), Emu(437000), Emu(437000), Emu(441000)],
          highlight_cells=[(1, 1), (1, 3), (1, 4), (1, 7), (1, 8)],
          first_col_fill=COLOR_BG_BLUE)
...
rank_data = [
    ["", "H29", "H30", "R1", "R3", "R4", "R5", "R6", "R7"],
    ["小(/65)", "59", "56", "62", "53", "62", "31", "63", "64"],
    ["中(/33)", "22", "31", "33", "7", "5", "3", "25", "22"],
]
add_table(slide4, Emu(180000), Emu(2080000), Emu(4350000), Emu(420000),
          rank_data, body_size=8, header_size=8,
          col_widths=[Emu(600000), Emu(468000), Emu(468000), Emu(468000), Emu(468000), Emu(468000), Emu(468000), Emu(468000), Emu(474000)],
          highlight_cells=[(1, 7), (1, 8), (2, 7), (2, 8)],
          first_col_fill=COLOR_BG_BLUE)
...
add_section_label(slide4, Emu(180000), Emu(3830000), Emu(4350000), Emu(220000),
                  "  R7最新データの総合所見", COLOR_HEADER, size_pt=9)
shoken_text = (
    "● 学力R7：小は国語65・算数52、中は国語56・数学52\n"
    "  ─ 区平均・都平均を大きく下回り、小は区最下位水準\n"
