...
# ② 歴史（A-2：創立者＝地域の方々の意志に焦点／153字）
para(
    "　本校は、明治九年、南蔵院本堂の一部を学び舎として、地域の方々が教員二名・"
    "児童八十名を迎え入れたところから歩みを始めました。新しい学び舎に「豊玉」の名を"
    "贈られたのは、稲穂のように子どもの心も豊かに実れとの切なる願いを託すためであり、"
    "その願いは、百五十年を経て一万二千六百六十八名の同窓に受け継がれております。",
    size=11
)
