...
# ② 歴史（B案：多様性軸で改稿、150周年らしい新しい解釈を付与）
para(
    "　本校は明治九年、南蔵院本堂の一部を学び舎に、教員二名・児童八十名で"
    "開校されました。校名「豊玉」には、稲穂のように子どもの心も豊かに育って"
    "ほしいという地域の願いが込められております。多様な子ども一人ひとりを"
    "大切にする今日、その願いは新たな重みを帯び、一万二千六百六十八名の"
    "同窓に受け継がれてまいりました。",
    size=11
)
