...
# ② 歴史（案2：現在から過去へ遡る視点／別テイスト・約152字）
para(
    "　いま豊玉小学校に学ぶ児童一人ひとりの背後には、明治九年に南蔵院本堂で"
    "学び始めた八十名の児童と二名の教員以来、一万二千六百六十八名の先輩たちの"
    "確かな歩みがあります。校名「豊玉」に込められた、稲穂のように子どもの心も"
    "豊かに実れとの地域の願いを、世代から世代へと受け継ぎ、今日の教室にまで"
    "運んでこられたのです。",
    size=11
)
